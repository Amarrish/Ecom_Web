...
const CartItemContent = ({cartItem}) => {
  ...
  console.log(cartItem,"cartItem_cartitemcontent");
  ...
  function handleCartItemDelete(getCartItem) {
    dispatch(
      deleteCartItem({ userId: user?.userId, productId: getCartItem?.productId }) // changed to userId
    ).then((data) => {
      if (data?.payload?.success) {
